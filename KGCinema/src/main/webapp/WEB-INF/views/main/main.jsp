     ...
     <c:forEach var="item" items="${movie}">
       <div class="movie_1 rel">
         <div class="hover_1" style="width:100%;height:100%;padding-top:50px;z-index:999;position: absolute;display:block;">
             <a href="reserveMain.do" style="display:none;text-decoration:none;margin:0 15px;border:1px solid #c1b687;height:48px;font-size:15px;font-weight:bold;color:#c1b687;text-align: center;padding-top:10px;">예매하기</a>
